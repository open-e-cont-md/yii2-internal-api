...
namespace openecontmd\internal_api\modules\internal;
...
{
	public $controllerNamespace = 'openecontmd\internal_api\modules\internal\controllers';
	public $gate = null;
...
//		$this->gate = Yii::$app->session->get('gate');
		...
		//$this->_check_token();
//		$method = str_replace('internal/v1/', '', $this->module->requestedRoute);
