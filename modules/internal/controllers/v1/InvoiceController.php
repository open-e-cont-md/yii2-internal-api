...
use openecontmd\internal_api\models\InternalInvoiceAPI;
 ...
 *              @OA\Examples(example="result_invoice", value={
 ...
 "controller": "invoice",
 "entry_point": "https://api.open.e-cont.md/internal/v1/invoice/{action}"
 }
...
/** Set Invoice Number
 * @OA\Post(
 *     path="/internal/v1/invoice/set-invoice-number",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
...
/** Set Issue Date
 * @OA\Post(
 *     path="/internal/v1/invoice/set-issue-date",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
...
/** Set Due Date
 * @OA\Post(
 *     path="/internal/v1/invoice/set-due-date",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact Name
 * @OA\Post(
 *     path="/internal/v1/invoice/set-contact-name",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact E-Mail
 * @OA\Post(
 *     path="/internal/v1/invoice/set-contact-email",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
...
/** Set Identifier
 * @OA\Post(
 *     path="/internal/v1/invoice/set-identifier",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
...
/** Create Invoice
 * @OA\Post(
 *     path="/internal/v1/invoice/create-invoice",
 *     method="post",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	public function actionCreateInvoice()
	{
	    ...
	    $r1 = InternalInvoiceAPI::checkInvoiceByNumber($id);
	    if ($r1) {
	        throw new HttpException(401, 'Повторный номер инвойса');
	    }
	    else {
	        $uid = InternalInvoiceAPI::createUid();
	        $r2 = InternalInvoiceAPI::createInvoice($uid, $id, $ubl_document);
	    }
 ...
 * @OA\Post(
 *     path="/internal/v1/invoice/create-invoice-by-object",
 *     tags={"internal"},
 ...
 * @OA\Post(
 *     path="/internal/v1/invoice/create-party-by-object",
 *     tags={"internal"},
...
/** Get Party By Id
 * @OA\Post(
 *     path="/internal/v1/invoice/get-party-by-id",
 *     method="post",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
 ...
 * @OA\Post(
 *     path="/internal/v1/invoice/get-invoice-by-number",
 *     method="post",
 *     tags={"internal"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	...
	{
	    $id = Yii::$app->request->get('id');
	    $r1 = InternalInvoiceAPI::getInvoiceByNumber($id);
